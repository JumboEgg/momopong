...
const storyData: StoryPage[] = [
  {
    ...
    contents: [{
      type: 'narration',
      text: '옛날 옛적, 착한 소녀 신데렐라가 살았습니다.\n신데렐라는 어린 시절 부모님을 잃고 새어머니, 두 언니와 함께 살게 되었지요.\n그들은 마음씨 착하고 예쁜 신데렐라를 미워하고 구박했습니다.',
      audioFiles: ['01.mp3'],
    }],
  },
  {
  ...
  },
  {
    ...
    contents: [{
      type: 'narration',
      text: '요정 할머니는 잠시 고민하더니 신데렐라에게 정원에서 호박을 가져와 달라고 했습니다.\n신데렐라는 가장 크고 좋은 호박을 가져와 밖에서 기다리는 할머니에게 건네주었습니다.\n요술 지팡이가 호박에 닿자 순식간에 황금으로 뒤덮인, 아름다운 마차로 변했습니다.',
      audioFiles: ['07.mp3'],
    }],
  },
  {
  ...
  },
  {
    ...
    contents: [{
      type: 'narration',
      text: '요정 할머니는 인자하게 웃으며 요술 지팡이로 신데렐라를 아주 살짝 건드렸습니다.\n그러자, 신데렐라의 옷이 예쁜 드레스로 변했답니다.\n요정 할머니는 마지막으로 아름다운 구두를 신데렐라에게 건넸습니다.',
      audioFiles: ['11.mp3'],
    }],
  },
  {
    ...
    contents: [
      {
        type: 'narration',
        text: '구두까지 신은 신데렐라는 마차에 올라탔답니다. 그때 요정 할머니가 말했습니다.',
        audioFiles: ['12.mp3'],
      },
      {
        type: 'narration',
      ...
      {
        type: 'narration',
        text: '그 말을 끝으로 마차가 출발했습니다.\n신데렐라는 떨리는 마음을 주체할 수 없었습니다. 점차 성이 가까워졌습니다.',
        audioFiles: ['15.mp3'],
      },
    ],
  },
  {
    ...
    contents: [{
      type: 'narration',
      text: '그 시각, 성 안에서는 왕자님이 왕과 왕비 곁에서 곤란해하고 있었어요.\n부모님은 어서 왕자가 제 짝을 찾기를 바랐거든요.\n그때 마침 새로운 손님이 도착했다는 소식이 들려왔어요.\n왕자님은 반짝이는 가면을 쓴 신데렐라를 보자마자 마치 봄날의 꽃을 본 것처럼 설레었답니다.',
      audioFiles: ['16.mp3'],
    }],
  },
  {
    ...
    contents: [
      ...
      {
        type: 'narration',
        text: '신데렐라는 고개를 끄덕이고는 그의 손을 잡고 무도회장 중앙으로 이동했습니다.\n두 사람은 누가 보기에도 잘 어울리는 아름다운 한 쌍이었습니다.\n같은 자리에 있던 새언니와 새엄마조차 그녀가 신데렐라라는 생각도 하지 못한 채 그저 넋 놓고 그들을 바라보기 바빴습니다.\n곡이 끝나자 왕자는 다른 귀족들의 시선은 아랑곳하지 않는 듯 신데렐라의 손을 살며시 잡고 말했습니다.',
        audioFiles: ['18.mp3'],
      },
      {
        type: 'prince',
  ...
  },
  {
    ...
    contents: [
      ...
      {
        type: 'prince',
        text: '"이상하게도 당신과 함께 있으면 마음이 편안해집니다. 그러고 보니 아직 이름조차 모르는군요. 알려 주시겠습니까?"',
        audioFiles: ['21.mp3'],
      },
    ],
  },
  {
    ...
    contents: [{
      type: 'narration',
      text: '그때 갑자기 종소리가 울렸어요.\n신데렐라는 깜짝 놀라 도망치듯 달려갔고, 황금빛 마차는 어둠 속으로 사라졌답니다.\n계단에서 떨어진 유리 구두 한 짝만이 달빛 아래 반짝였어요.',
      audioFiles: ['22.mp3', '23.mp3'],
    }],
  },
  {
    pageNumber: 12,
  ...
  },
  {
    ...
    contents: [
      {
        type: 'narration',
        text: '다음날, 왕자는 시종들을 이끌고 귀족들의 집을 하나씩 방문하게 되었습니다.\n그들은 곧 신데렐라의 집에도 찾아왔어요.\n두 언니도 구두를 신어봤지만 당연하게도 들어가지 않았습니다.\n신데렐라의 발은 아주 작았거든요.',
        audioFiles: ['26.mp3'],
      },
      {
        type: 'prince',
  ...
  },
  {
    ...
    contents: [
      {
        type: 'narration',
        text: '구두가 신데렐라의 발에 쏙 들어갔어요.\n그때 요정 할머니가 나타나 마법으로 신데렐라를 다시 아름답게 만들어주었답니다.\n왕자는 기뻐하며 신데렐라의 손을 잡았습니다.',
        audioFiles: ['33.mp3'],
      },
      {
        type: 'prince',
