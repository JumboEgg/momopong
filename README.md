...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 2/10 | --- | --- | --- | --- | 스토리모드 컴포넌트 생성
모드선택, 싱글모드, 함께모드 컴포넌트 생성
스토리 동화 삽화 생성 | --- | --- |
| 2/11 | --- | --- | --- | --- | 스토리 텍스트 생성 및 수정
스토리 음성 생성 및 수정
스토리 데이터 수정| --- | --- |
| 2/12 | --- | --- | --- | --- | 오디오 오류 수정
함께모드 친구 초대틀 추가
스토리 싱글모드 동화 삽화 삽입 | --- | --- |
| 2/13 | --- | --- | --- | --- | 스토리 싱글모드 페이지 넘김 처리
스토리 싱글모드 동화 음성 삽입
스토리 함께모드 동화 삽화 삽입 | --- | --- |
| 2/14 | --- | --- | --- | --- | 스토리 함께모드 동화 음성 삽입
스토리 함께모드 페이지 넘김 처리
스토리 함께모드 녹음 기능 추가 | --- | --- |
...
| **날짜** | **전체** | **구현진** | **박준현** | **윤지원** | **이하리** | **정은아** | **허정은** |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 2/17 | --- | --- | --- | --- | 스토리 함께모드 역할 배정 기능 추가
역할 배정 기능 수정
스토리 함께모드 오픈비두 기능 추가
라이브킷 라이브러리 비디오, 오디오 스트리밍 구현 | --- | --- |
| 2/18 | --- | --- | --- | --- | 실시간 동기화 구현
함께모드 녹음기능 수정
인사페이지 구현
인사페이지 마이크 수정 | --- | --- |
...
자막위치, 크기, 폰트 수정
페이지 넘김 오류 수정 | --- | --- |
| 2/20 | --- | --- | --- | --- | 녹음완료후 페이지 넘기 처리 오류 수정
화상비디오 크기조절 및 하이라이트 기능 추가
인사페이지 스타일 수정 | --- | --- |
| 2/21 | --- | --- | --- | --- | --- | --- | --- |
