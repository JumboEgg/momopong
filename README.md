...
| 1/17 | 기획 구체화 및 학습, 사전세팅 | RefreshToken Redis 저장 방식 학습 | Jenkins 기초 학습 , 실험 세팅 | ESLint airbnb ts 규칙 적용, 타입스크립트 기초 학습 | React 배포 학습, 리액트(라이프사이클, 최적화 학습) | Redis 개념 학습 및 설치, ERD 구상 | React 기존 예제 프로젝트 학습 |
