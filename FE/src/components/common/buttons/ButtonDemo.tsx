      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 items-center">
              <IconCircleButton size="sm" variant="action" className="" disabled icon={<FontAwesomeIcon icon={faPause} size="lg" />} />
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4">
            <div className="flex gap-4 items-center">
              ...
              <IconCircleButton size="md" variant="story" className="" icon={<FontAwesomeIcon icon={faCaretRight} size="lg" />} hasFocus={false} />
              {/* 이 버튼은 focus가 동작합니다 */}
              <IconCircleButton
                size="lg"
                variant="story"
